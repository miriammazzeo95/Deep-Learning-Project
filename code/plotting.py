...
def make_vae_plots(vae, x, y, outputs, outputs_matches, training_data, validation_data, tmp_img="tmp_vae_out.png", figsize=(18, 18)):
...
def ex_plots(vae, x, y, outputs, training_data, validation_data, tmp_img="tmp_vae_out.png", figsize=(18, 18)):
